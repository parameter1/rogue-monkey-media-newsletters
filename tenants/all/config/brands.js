module.exports = {
  nrwa: {
    ...
    advertiseLink: 'https://content-nrwa-org.www.base.parameter1.com/page/advertise',
    contactUslLink: 'https://content-nrwa-org.www.base.parameter1.com/page/contact-us',
    bgColor: '#3856a6',
    socialMedia: {
